...
public class AutoTraverseNeutralZoneAwayFromBoiler extends CommandGroup {
    ...
    public AutoTraverseNeutralZoneAwayFromBoiler() {
        ...
        addSequential(new AutoDrive(Constants.Auto.AnglesAndDistances.ESCAPE_CENTER_DISTANCE, Constants.Auto.Drive.SPEED, 2000));
        addSequential(new AutoAlign(Constants.Auto.AnglesAndDistances.STRAIGHT_ANGLE, Constants.Auto.Align.SPEED));
        addSequential(new AutoDrive(Constants.Auto.AnglesAndDistances.TRAVERSE_NEUTRAL_ZONE_FROM_CENTER_DISTANCE, Constants.Auto.Drive.SPEED, 5000));
    }
