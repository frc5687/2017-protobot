...
public class AutoDepositCenterDeadReckoning extends CommandGroup {
    ...
    public AutoDepositCenterDeadReckoning() {
        super();
        addSequential(new AutoDrive(12, Constants.Auto.Drive.SPEED * .5, false, false, 250, "Initial Center"));
        addSequential(new AutoDrive(18, Constants.Auto.Drive.SPEED, false, false, 250, "Fast Center"));
