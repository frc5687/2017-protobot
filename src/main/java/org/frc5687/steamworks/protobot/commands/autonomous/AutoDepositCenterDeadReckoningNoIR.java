...
public class AutoDepositCenterDeadReckoningNoIR extends CommandGroup {

    public AutoDepositCenterDeadReckoningNoIR() {
        super();
        addSequential(new AutoDrive(36, .7, false, false, 2000, "Initial Center"));
        addSequential(new AutoDrive(38, .4, false, false, 2000, "Approach"));
